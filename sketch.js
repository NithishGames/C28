...
function setup() {
	...
	ground1 = new Ground (750,690,1500,40)
	ground2 = new Ground (1490,350,40,700)
	ground3 = new Ground (10,350,40,700)
	ground4 = new Ground (750,10,1500,40)
	tree = new Tree(1000,360,700,700)
	mango1 = new Mango(670,300,25,25)
	mango2 = new Mango(760,350,25,25)
	mango3 = new Mango (830,350,25,25)
	mango4 = new Mango(800,200,30,25)
	mango5 = new Mango (1200,350,25,25)
	mango6 = new Mango (1110,350,25,25)
	mango7 = new Mango (925,350,30,25)
	mango8 = new Mango (1300,350,25,25)
	mango9 = new Mango (1320,280,30,25)
	mango10 = new Mango (710,230,25,25)
	boy = new Boy (350,590,265,350)
	stone = new Stone (265,500,25,25) 

	slingshot = new launcher(stone.body,{x:265,y:500});  
}
